  ...
  return (
    <div className={`card card-custom ${className}`}>
      ...
      <div className="card-header border-0 pt-5">
        <h3 className="card-title font-weight-bolder ">AdellCare Plan</h3>
      ...
      <div className="card-body d-flex flex-column">
        ...
        <div className="pt-5">
          ...
          <a href="#" className="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">Upgrade Plan</a>
        </div>
      </div>
    </div>
  );
